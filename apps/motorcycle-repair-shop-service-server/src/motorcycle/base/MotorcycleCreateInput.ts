...
class MotorcycleCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RepairCreateNestedManyWithoutMotorcyclesInput,
  })
  @ValidateNested()
  @Type(() => RepairCreateNestedManyWithoutMotorcyclesInput)
  @IsOptional()
  @Field(() => RepairCreateNestedManyWithoutMotorcyclesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => CustomerCreateNestedManyWithoutMotorcyclesInput,
  })
  @ValidateNested()
  @Type(() => CustomerCreateNestedManyWithoutMotorcyclesInput)
  @IsOptional()
  @Field(() => CustomerCreateNestedManyWithoutMotorcyclesInput, {
    nullable: true,
  })
...
export { MotorcycleCreateInput as MotorcycleCreateInput };
