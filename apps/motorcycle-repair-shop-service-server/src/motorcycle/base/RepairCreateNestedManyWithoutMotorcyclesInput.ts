...
@InputType()
class RepairCreateNestedManyWithoutMotorcyclesInput {
...
export { RepairCreateNestedManyWithoutMotorcyclesInput as RepairCreateNestedManyWithoutMotorcyclesInput };
